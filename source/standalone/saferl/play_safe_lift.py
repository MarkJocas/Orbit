...
def main():
    # parse configuration
    env_cfg = parse_env_cfg("SafeRL-Lift-Franka-v0", use_gpu=not args_cli.cpu, num_envs=args_cli.num_envs)
    ...
    # create environment
    env = gym.make("SafeRL-Lift-Franka-v0", cfg=env_cfg, headless=args_cli.headless)
